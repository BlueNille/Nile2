        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameTextView.setText(com.example.nile2.Prevalent.currentOnlineUser.getName());
        Picasso.get().load(com.example.nile2.Prevalent.currentOnlineUser.getImage()).placeholder(R.drawable.profile).into(profileImageView);
