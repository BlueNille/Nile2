...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String UserPhoneKey = Paper.book().read(com.example.nile2.Prevalent.UserPhoneKey);
        String UserPasswordKey = Paper.book().read(com.example.nile2.Prevalent.UserPasswordKey);
